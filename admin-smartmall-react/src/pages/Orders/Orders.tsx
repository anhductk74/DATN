...
export default function Orders() {
  ...
  // Fetch all orders with React Query
  const { data: ordersData, isLoading, refetch } = useOrders(page, pageSize, statusFilter || undefined);
      ...
      <Card>
        <Space direction="vertical" size="middle" style={{ width: '100%' }}>
          <div className="orders-filters">
            <Space wrap>
              <Input
                placeholder="Search orders (customer, shop, ID)..."
                allowClear
                size="large"
                style={{ width: 350 }}
                value={searchText}
