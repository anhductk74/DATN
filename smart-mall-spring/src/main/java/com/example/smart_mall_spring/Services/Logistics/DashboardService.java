...
public class DashboardService {
    ...
    private DashboardSummaryDto buildSummary(LocalDate from, LocalDate to) {
        ...
        BigDecimal codCollected = transRepo.sumAmountByTypeAndDate(TransactionType.COLLECT_COD, from, to);
        BigDecimal codDeposited = transRepo.sumAmountByTypeAndDate(TransactionType.DEPOSIT_COD, from, to);
        BigDecimal bonus = transRepo.sumAmountByTypeAndDate(TransactionType.BONUS, from, to);
