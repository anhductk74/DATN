...
public interface ShipperTransactionRepository extends JpaRepository<ShipperTransaction, UUID> {
    ...
    List<ShipperTransaction> findByTransactionType(TransactionType transactionType);
    ...
    @Query("""
        ...
        WHERE t.shipper.id = :shipperId
          AND t.transactionType = com.example.smart_mall_spring.Enum.TransactionType.COLLECT_COD
    """)
    ...
    boolean existsByShipmentOrder_IdAndTransactionType(UUID shipmentOrderId, TransactionType type);
